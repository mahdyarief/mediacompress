...
type ImageInputDetailsProps = {
  imageFiles: FileActions[];
  onClear: () => void;
};

export const ImageInputDetails = ({
  imageFiles,
  onClear,
}: ImageInputDetailsProps) => {
  const totalSize = imageFiles.reduce((sum, file) => sum + file.fileSize, 0);
